...
import time
from Common.Pubilc_Function import PostAndGet, get_md5_value,processRun
import unittest
import threading
...
#         url = "https://ssl-api.putao.cn/scmsface/view/ads"
        ...
        #self.assertLessEqual(data[3], 10)
        print "\n"
        
    def test_ProcessViewAd(self):
        method="GET"
        rest="/scmsface/view/ads"
        arg={"sys_version":"5.0","channel_no":"huawei_life","app_version":"2.3.0","device":"HUAWEI GRA-UL00","device_no":"866696022436818","location":"30.2784662,120.1194347","city": u"深圳","scene":"0","data_version":"220042","timestamp":"1436286885578","sign":"2ebc2e599db3e5180bd3c33487af4664","local_sign":""}
        proc=100
        processRun(self.viewAd,arg,proc)
